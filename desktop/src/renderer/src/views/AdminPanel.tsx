  ...
  return (
    <div className="admin-panel">
      ...
      <section className="admin-backend" data-testid="backend-picker">
        ...
        {backendIsRemote && Number(valueOf('track_expiry_s')) < MIN_REMOTE_TRACK_EXPIRY_S && (
          <p className="admin-warning" data-testid="expiry-warning">
            ...
            outlast that and log one item twice — use at least {MIN_REMOTE_TRACK_EXPIRY_S}s with
            an API backend.
          </p>
        )}
        ...
        {probeResult && (
          ...
          >
            ...
            {probeResult.class_names.length > 0 &&
              ` — ${probeResult.class_names.length} classes`}
          </p>
        )}
      </section>
